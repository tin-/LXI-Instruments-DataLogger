...
To minimize SHE(Self-Heating Effect) with FlexPCB use 0x2A0 configuration word of TMP117. Also you can set "delay" in config to prevent frequent reading, it also reduce SHE. I recommend set delay like as shown in Table 7 datasheet.
